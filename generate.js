...
REGRA CRÍTICA - GERAÇÃO DE SCRIPTS COMPLETOS:

Sempre que gerar script FiveM, é OBRIGATÓRIO incluir:
- fxmanifest.lua
- client.lua
- server.lua (mesmo que simples)
- config.lua (se aplicável)

Se o sistema tiver interface (NUI):
- Criar pasta html/
- index.html
- style.css
- script.js

É PROIBIDO gerar apenas client.lua ou projetos incompletos.
...
VALIDAÇÃO: Antes de finalizar, verifique se todos os arquivos acima foram gerados. Se faltar algum, adicione-o automaticamente.`;
